...
def create_splits(cfg: dict):
    ...
    output_file = Path(f'{output_dir}/kfold_splits_seed{cfg["seed"]}.p')  # Convert to Path object
    # Overwrite the output file if it already exists
    if output_file.is_file():  # Use Path method is_file()
        output_file.unlink()  # Use Path method unlink()
