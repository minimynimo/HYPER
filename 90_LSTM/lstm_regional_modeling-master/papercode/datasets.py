...
class CamelsTXT(Dataset):
    ...
    def __init__(self,
        ...
        # Set missing attributes for varssim data
        self.file_num = basin
        self.varssim_dir = "/data0/funato/hsp/2_MERV/varssim_HBV"
        self.loc = "GB"
    ...
    def _load_data(self) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        x = normalize_features(x, variable='inputs', loc=self.loc)
        ...
        if self.is_train:
            ...
            y = normalize_features(y, variable='output', loc=self.loc)
